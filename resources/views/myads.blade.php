...
@section('meta_tags')
<meta name="keywords" content="{{Auth::user()->fname.'\'s Properties' .', '.__('messages.meta_keyword_myads') }}"> 
<meta name="description" content="{{ Auth::user()->fname.'\'s Properties' .' | '.__('messages.meta_desc_myads') }}"> 
@endsection
			...
			<form action="{{ url('myads') }}" method="post" id="sidebarForm">
				...
				<div class="main col-sm-8" style="padding-top: 0;">
					<div id="listing-header" class="clearfix" style="margin-top: 55px;">
						...
						<div class="view-mode">
							<a href="#" class="btn btn-fullcolor">{{ __('messages.lbl_view_map') }}</a>
						</div>
