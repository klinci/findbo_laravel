			...
			<div class="container">
				<div class="row">
					...
					<div class="main col-sm-12">
						<form action="{{ url('message_sent') }}" method="post" name="frmSent" id="frmSent">
							{{ csrf_field() }}
						...
						<div class="col-md-12">
							<ul class="nav nav-tabs tabs-left">
								<li class=""><a href="{{ url('message_inbox') }}" ><i class="fa fa-inbox"> {{ __('messages.lbl_inbox') }}</i></a></li>
								<li class="active"><a href="{{ url('message_sent') }}" ><i class="fa fa-envelope-o"> {{ __('messages.lbl_sent') }}</i></a></li>
							</ul>
