...
Som boligsøgende kan du oprette en boligsøgerannonce på findbo.dk. Du accepterer at modtage e-mails fra www.findbo.dk med relevante boliger, der er til leje afhængig af din søgeprofil. Findbo.dk videregiver ikke din e-mail adresse eller andre oplysninger til tredjepart.</p>
					...
					<p>Ved abonnementsbetaling fornyes aftalen automatisk for hver 30. dag. Første gang du tilmelder dig, vil beløbet automatisk blive trukket fra din konto inden for 4 dage. Du kan til enhver tid opsige dit abonnement. Hvis dit betalingskort udløber eller bliver spærret, bliver abonnementsaftalen sat i bero. Der vil herefter blive foretaget en ny trækning, og hvis det mislykkes, vil abonnementsaftalen blive indstillet. Ved ændring af betalingskort for din abonnementsaftale, skal aftalen opsiges. FindboPakken genkøbes herefter med dit nye betalingskort.</p>
