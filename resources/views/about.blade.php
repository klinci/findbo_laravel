...
@section('meta_tags')
<meta name="description" content="Om Findbo.dk  - Velkommen til Findbo. Vi er en ny Boligportal for Udlejere og Lejere – og for Sælgere og Købere af Ejendomme. Nemt og Enkelt at Finde en Bolig."> 
				...
				<div class="row">
					<div class="main col-sm-12 section-about">
						...
						<div class="col-sm-6">
							...
							<p data-animation-direction="from-left" data-animation-delay="200">Konceptet bag <a target="_blank" href="https://www.findbo.dk/">findbo.dk</a> er at skabe en mere billig, gennemsigtig og brugervenlig portal for boligmarkedet i Danmark. Det betyder, at lejere, udlejere, købere og sælgere af boliger skal sikres gennemsigtighed, så alle føler sig virkelig godt behandlet. Vi har en indbygget kommunikationsplatform, hvor man kan kontakte udlejere og sælgere. Vi kan tilbyde vores udlejere og sælgere en gratis og effektiv formidling af boliger.</p> 
						</div>
						<div class="col-sm-6">
							<h2 data-animation-direction="from-right" data-animation-delay="200">Sælg eller Udlej en Bolig</h2>
							<p data-animation-direction="from-right" data-animation-delay="200">Findbo.dk tilbyder en let anvendelig kommunikationsplatform. Der er mange besøgende på hjemmesiden hver dag. Boligerne markedsføres professionelt, og de ses af rigtig mange potentielle lejere og købere. Hver gang en lejer eller køber henvender sig via kommunikationsplatformen, vil sælger eller udlejer få en mail, hvor det fremgår hvilken bolig, det drejer sig om, og hvem det er, der henvender sig.</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 about-services">
						...
						<div class="col-md-6" data-animation-direction="from-bottom" data-animation-delay="650">
							...
							<p class="col-md-10">Du er altid velkommen til at tage kontakt til Findbo uanset, om det er for at finde, købe, udleje eller sælge boliger. Du kan regne med en konstruktiv dialog med Findbos medarbejdere om de ønsker og behov, du måtte have for at finde eller udleje eller sælge boligen.</p>
						</div>
					</div>
				</div>
