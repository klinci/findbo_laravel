...
@section('pageTitle', 'Zipcode List')
...
<div class="clearfix midpart">
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<div class="maintitle">
				<h3 class="topspace">Zipcode List</h3>
				<div class="timebox">
					<a href="{{ url('admin/zipcode/create') }}" class="btn btn-primary">Add Zipcode</a>
				</div>
			</div>
...
$(document).ready(function () {
    ...
    $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax":{
                 "url": "{{ url('/admin/zipcode/ajaxzipcode') }}",
                 "dataType": "json",
                 "type": "POST",
