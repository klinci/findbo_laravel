			...
			<div class="x_panel">
				<div class="row">
					<div class="col-md-12  col-sm-12 ptp10">
						...
						<form class="form-horizontal" name="frmProperty" id="frmProperty" method="get" action="{{ url('admin/seekads/index')}}">
							<div class="item form-group">
								<label class="col-sm-5 col-md-5 control-label" for="name">Search By Area, Email ID OR Seeker Name</label>
							...
							<div class="item form-group">
								<label class="col-sm-5 col-md-5 control-label" for="name">Published Date From</label>
								<div class="col-sm-7 col-md-3">
							...
							<div class="item form-group">
								<label class="col-sm-5 col-md-5 control-label" for="name">Published Date To</label>
								<div class="col-sm-7 col-md-3">
							...
							<div class="item form-group">
								<label class="col-sm-5 col-md-5 control-label" for="name">Seek Ad ID</label>
								<div class="col-sm-7 col-md-3">
							...
							<table class="table">
								<tr>
									<td class="nopaddingtd">
										<form method="post" action="{{ url('admin/seekads/deleteproperties') }}" name="frmDelete" id="frmDelete">
											{{csrf_field()}}
...
$(document).ready(function () {
	...
	$("#btnClear").click(function(){
		window.location.href="{{ url('admin/seekads/index') }}";
	});
    ...
    $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax":{
                 "url": "{{ url('/admin/seekads/ajaxseekads') }}",
                 "dataType": "json",
                 "type": "POST",
